...
class VCAP::Services::Mysql::Node
  ...
  def initialize(options)
    ...
    @available_storage = options[:available_storage]
    ProvisionedService.all.each do |provisioned_service|
      @available_storage -= VCAP::Services::Mysql::Node.storage_for_service(provisioned_service)
    end
  ...
  def self.storage_for_service(provisioned_service)
  ...
  def on_unprovision(msg, reply)
    ...
    storage = VCAP::Services::Mysql::Node.storage_for_service(provisioned_service)
